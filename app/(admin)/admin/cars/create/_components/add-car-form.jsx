...
export const AddCarForm = () => {
  ...
  // Actual File objects are stored here
  const [uploadedImages, setUploadedImages] = useState([]);

  // Preview URLs are stored separately
  ...
  useEffect(() => {
    if (processImageResult?.success) {
      ...
      // Add the actual File object to uploaded images
      if (uploadedAiImage) {
        setUploadedImages((prev) => [...prev, uploadedAiImage]);

        // Create a separate preview URL
        const previewUrl = URL.createObjectURL(uploadedAiImage);
      ...
      // Switch to manual tab for the user to review
